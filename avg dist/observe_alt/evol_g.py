...
for file in config_files[1:]:
    ...
    cc = cf.ConfigCollector(expr_name = expr_name, folder = str(script_dir) + '/results_g')
    ...
    pf = gpf.GeneticPF(model, particle_count = 500, record_path = cc.res_path + '/assimilation.h5')
    ...
    pf.plot_trajectories(hidden_path, coords_to_plot=[0, 10, 20, 30], file_path=cc.res_path + '/trajectories.png', measurements=False)
